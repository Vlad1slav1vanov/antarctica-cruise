...
/* harmony import */ var _modules_feedback_form__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/feedback-form */ "./js/modules/feedback-form.js");
/* harmony import */ var _modules_burger_menu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/burger-menu */ "./js/modules/burger-menu.js");
/* harmony import */ var _modules_burger_menu__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_burger_menu__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _modules_links_scroll__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/links-scroll */ "./js/modules/links-scroll.js");
/* harmony import */ var _modules_links_scroll__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_links_scroll__WEBPACK_IMPORTED_MODULE_5__);
...
var menu = document.querySelector(".header__main-navigation");
var list = menu.querySelector(".main-navigation__list");
var logo = document.querySelector(".header__main-logo");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _form_validate_init_phone_input__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./form-validate/init-phone-input */ "./js/modules/form-validate/init-phone-input.js");
/* harmony import */ var _form_validate_validator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./form-validate/validator */ "./js/modules/form-validate/validator.js");


var formCheckbox = document.getElementById("form-checkbox");
var accessCheckbox = document.getElementById("access-checkbox");
var validator = new _form_validate_validator__WEBPACK_IMPORTED_MODULE_1__["Validator"]();
formCheckbox.addEventListener("click", function () {
  accessCheckbox.click();
});
var phoneParent = document.querySelector(".feedback-form__phone-wrapper");
var phoneInput = document.getElementById("phone-input");
var form = document.querySelector(".feedback-form");
Object(_form_validate_init_phone_input__WEBPACK_IMPORTED_MODULE_0__["initPhoneInput"])(phoneParent);
pageForm.addEventListener("submit", function (evt) {
  var isValid = validator._validatePhoneInput(pagePhoneParent, pagePhoneInput);
  if (!isValid) {
    evt.preventDefault();
    phoneInput.focus();
  }
...
var benefitsBlock = document.getElementById("benefits");
var cruisesLink = document.getElementById("cruises-link");
var cruisesBlock = document.getElementById("cruises");
var contactsLink = document.getElementById("contacts-link");
var contactsBlock = document.getElementById("contacts");
var scrollEvt = function scrollEvt(block, link) {
